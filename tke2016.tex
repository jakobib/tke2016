...
\item \textbf{Entity Search} queries a list of concepts matching a query string with relevance ranking. The access method is intended for typeahead to select a concept of unknown URI. The response format is the same as OpenSearch Suggestions API \cite{Clinton2006}. % (\ref{fig:entity-search}).
